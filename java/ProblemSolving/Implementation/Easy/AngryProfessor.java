...
The professor wants at least 2 students in attendance, and there are 3 who have arrived on time (0 and -1) so the class is not cancelled.
 */
...
public class AngryProfessor {
    ...
    static String angryProfessor(int k, int[] a) {
        long onTime = Arrays.stream(a).filter(x -> x <= 0).count();

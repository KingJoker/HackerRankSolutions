...
For each element V in an array of N numbers, Insertion Sort compares the number to those to its left until
it reaches a lower value element or the start.
...
*What this means
The running time of the algorithm against an array of N elements is N^2. For 2*N elements, it will be 4*N^2.

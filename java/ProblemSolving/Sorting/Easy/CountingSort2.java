...
Rather than using a comparison, you create an integer array whose index range covers the
entire range of values in your array to sort.
...
It should return the original array, sorted ascending, as an array of integers.

...
Now, four more students are added to Q. So, it contains (Shafaet, 3.7, 35), (Ashley, 3.9, 42), (Maria, 3.6, 46), (Anik, 3.95, 49),
and (Dan, 3.95, 50).
...
public class JavaPriorityQueue {
    ...
    private static class Student implements Comparable<Student> {
        ...
        public int compareTo(Student o) {
            int compare = -1 * ((Double) cgpa).compareTo(o.cgpa);
            if(compare != 0){
                return compare;
            }
    ...
    private static class Priorities{
        ...
        List<Student> getStudents(List<String> events){
            ...
            for(String event : events){
                ...
                switch(type){
                    case "ENTER":
                        students.offer(new Student(Integer.parseInt(query[3]),query[1],Double.parseDouble(query[2])));
                        break;
                    case "SERVED":
                        students.poll();
                        break;

...
first instance the word found in the sentence.
...
2. We remove the second occurrence of went and the second and third occurrences of to from
...
It's important to note that our matching is case-insensitive, and we specifically retained the first

...
For example, computing the hash of a downloaded file and comparing the result to a previously published hash result
...
in other words, it should be extremely difficult to produce the same hash output from two different input values using
...
with a variable digest size. SHA-256 is a 256-bit (32 byte) hashing algorithm which can calculate a
hash code for an input of up to 264-1 bits.
...
public class JavaSHA256 {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        System.out.println(String.format("%-64s", bi.toString(16)).replace(" ","0"));
    }

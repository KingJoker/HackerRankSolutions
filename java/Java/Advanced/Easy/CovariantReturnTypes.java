...
Implement the classes and methods detailed in the diagram below:
      ...
      /                                       \
Subclass                                       Subclass
Class: Jasmine                                 Class: Lily
Method: String whatsYourName()                 Method: String whatsYourName()
return "Jasmine"                               return "Lily"
      ...
      /                                      \
Subclass                                      Subclass
Class: WestBengal                             Class: AndhraPradesh
Method: Jasmine yourNationalFlower()          Method: Lily yourNationalFlower()
Return: An instance of Jasmine                Return: An instance of Lily
You will be given a partially completed code in the editor where the main method takes the
name of a state (i.e., WestBengal, or AndhraPradesh) and prints the national flower of that state using the
classes and methods written by you.
...
and then prints the name returned by that class' national flower's whatsYourName method.
